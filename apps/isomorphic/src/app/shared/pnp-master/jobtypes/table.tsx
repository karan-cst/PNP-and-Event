...
import { JobTypeListColumns } from './columns';
...
export type JobtypeDataType = (typeof JobtypeData)[number];
...
export default function JobTypesTable({
  ...
  const { table, setData } = useTanStackTable<JobtypeDataType>({
    tableData: JobtypeData,
    columnConfig: JobTypeListColumns,
    options: {
      initialState: {
        pagination: {
          pageIndex: 0,
