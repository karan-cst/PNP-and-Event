...
import DivisionTable, { DivisionDataType } from './division-list/table';
import CreateDivisin from './create-hsn/createHSN';
...
export default function DivisonPageHeader<T extends Record<string, any>>({
  title,
  breadcrumb,
  className,
  table,
