...
import { DivisionData, sbuData } from '@/data/division-data';
import DivisonPageHeader from '../sbu-page-header';

export type sbuDataType = (typeof sbuData)[number];
...
export default function SBUTable({
  ...
  const { table, setData } = useTanStackTable<sbuDataType>({
    tableData: sbuData,
