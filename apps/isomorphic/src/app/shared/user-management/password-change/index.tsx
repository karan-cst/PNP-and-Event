...
import { Button, Input, Password, Select, Text, Title } from 'rizzui';
...
import {
  ...
  PasswordFormFormInput,
} from '@/validators/NEW/passwordChnage.schema';
...
export default function USerPasswordChange({
  ...
  const onSubmit: SubmitHandler<PasswordFormFormInput> = (data) => {
