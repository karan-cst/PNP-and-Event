...
import { Button, FileInput, Input, Select, Switch, Text, Title } from 'rizzui';
  ...
  return (
    ...
    >
      {({
        ...
        if (!values.GSTNumber) {
          console.log('GST Number is empty');
        }
                    ...
                    render={({ field: { value, onChange } }) => (
                      <>
                        ...
                        <FileInput
                          ...
                          clearable
                          onClear={() => setValue('GSTCertificate', '')}
                    ...
                    render={({ field: { value, onChange } }) => (
                      <>
                        ...
                        <FileInput
                          ...
                          clearable
                          onClear={() => setValue('MSMECertificate', '')}
