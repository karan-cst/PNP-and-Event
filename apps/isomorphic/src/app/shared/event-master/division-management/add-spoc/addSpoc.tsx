...
import {
  DivisionFormInput,
  DivisionFormSchema,
  DivisionUserFormInput,
  DivisionUserFormSchema,
...
export default function AddSPOC({
  ...
  const onSubmit: SubmitHandler<DivisionUserFormInput> = (data) => {
  ...
  return (
    <Form<DivisionUserFormInput>
      validationSchema={DivisionUserFormSchema}
      resetValues={reset}
      onSubmit={onSubmit}
      useFormProps={{
        mode: 'onChange',
