...
import { EventTypesListColumns } from './columns';
...
export type EventtypesTableDataType = (typeof EventTypeData)[number];
...
export default function EventtypesTable({
  ...
  const { table, setData } = useTanStackTable<EventtypesTableDataType>({
    tableData: EventTypeData,
    columnConfig: EventTypesListColumns,
    options: {
      initialState: {
        pagination: {
          pageIndex: 0,
