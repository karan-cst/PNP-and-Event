...
import { PiCheckFatDuotone, PiDownloadDuotone, PiXBold } from 'react-icons/pi';
...
export const getPaymentColumns = (role?: string) => {
                ...
                <Flex align="center" justify="start" gap="3" className="pe-4">
                  ...
                  >
                    <ActionIcon
                      ...
                      onClick={() =>
                        openModal({
                          view: <PaymentDoneModalView id={row.original.id} />,
                          customSize: 600,
                        })
                      }
                    >
...
export function PaymentDoneModalView({ id }: { id: string }) {
  ...
  return (
    <div className="m-auto px-5 pb-8 pt-5 @lg:pt-6 @2xl:px-7">
      ...
      <PaymentApprove isModalView={false} id={id} />
    </div>
  );
}
