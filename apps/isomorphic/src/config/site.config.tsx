...
import logoImg from '@public/logo/onelogo.svg';
import { LAYOUT_OPTIONS } from '@/config/enums';
// import logoIconImg from '@public/logo-short.svg';
import logoIconImg from '@public/logo/download.png';
...
export const metaObject = (
  ...
  return {
    title: title ? `${title} - One Advertising` : siteConfig.title,
    description,
    openGraph: openGraph ?? {
      title: title ? `${title} - One Advertising` : title,
      description,
